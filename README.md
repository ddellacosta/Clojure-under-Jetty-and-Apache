...
Other approaches I found which were closer to what I was looking for include:
  ...
  * [Continuous Deployment of Clojure Web Applications](http://cemerick.com/2010/11/02/continuous-deployment-of-clojure-web-applications/) (Chas Emerick) This uses [pallet](http://palletops.com/).  I haven't really dug into it yet.  I'm guessing that this is probably kind of the gold-standard for deploying Clojure apps on a cloud platform in this day and age, but it's a bit more than I need at this point.  Nevertheless, this is probably the direction I'll be moving in sooner rather than later...
